  ...
  <body>
    ...
    <div class="wrapper">
      <div class="container">
        ...
        <img src="../assets/Arrow-PNG-Picture.png" alt="spinner-arrow" />
        
      </div>
      <div id="final-value">
        <p>Haga click en el boton para iniciar</p>
      </div>
    </div>
    <!-- Menubar -->
    <div class="menu">
    ...
    <img src="../assets/imagen_derecha-removed.png" alt="derecha" class="derecha"/>
